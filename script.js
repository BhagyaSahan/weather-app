...
const apikey = 'f6209abb1b2d1f7c29de2dc4abf36151'
...
async function getFetchData(endPoint, city) {
    const appiUrl = `https://api.openweathermap.org/data/2.5/${endPoint}?q=${city}&appid=${apikey}&units=metric`

    const response = await fetch(appiUrl)
